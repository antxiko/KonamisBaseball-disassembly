...
**The game is not ours.** *Konami's Baseball* was published by **Konami** for the MSX in 1984;
its catalogue number is **RC-724** and it is 16 KB. All rights over the game
...
The file `src/baseball.asm` is the commented disassembly of the cartridge. It is
...
If you worked on *Konami's Baseball* or hold rights over the game, and you would rather this
